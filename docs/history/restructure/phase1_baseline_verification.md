...
> recipe. Current rules are in `docs/rules/build_and_verification.md`: root app builds
...
`cl`. See [build_and_verification.md](../../rules/build_and_verification.md) for the exact
