#ifndef VISION_OUTPUT_DEVICE_WIDGET_H
#define VISION_OUTPUT_DEVICE_WIDGET_H
...
namespace Ui {
class VisionOutputDeviceWidget;
}

class VisionOutputDeviceWidget : public IDeviceWidget {
    Q_OBJECT

public:
    explicit VisionOutputDeviceWidget(std::shared_ptr<vc::device::IDevice> dv,
                                      vc::runtime::VisionOutputRunner *runner,
                                      ads::CDockWidget *dock = nullptr,
                                      QWidget *parent = nullptr);
    ~VisionOutputDeviceWidget();
...
private:
    Ui::VisionOutputDeviceWidget *ui;
...
#endif // VISION_OUTPUT_DEVICE_WIDGET_H
