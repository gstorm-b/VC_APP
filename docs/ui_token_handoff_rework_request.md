...
- `docs/ui_design_rules.md` now documents those token families.
...
`docs/ui_design_rules.md` section 6: custom-painted surfaces must read colours
...
- `docs/later_todo_list.md` and `docs/technical_debt_and_next_steps.md` do not
  claim full closeout until the above issues are fixed.
- Run the dark/light visual checklist from `docs/ui_design_rules.md`.
