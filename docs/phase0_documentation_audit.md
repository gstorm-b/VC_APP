...
- Created `docs/project_restructure_plan.md` as the staged restructure roadmap.
...
- Updated `docs/architecture_docs/ITask.md` to use the current task lifecycle
  and `TaskState` enum.
...
- `docs/task_localization/*.html`: likely generated mirrors of Markdown/module
  specs.
- `docs/calibration_module.html`: likely generated from
  `docs/calibration_module.md`.
- `docs/calib_board_recognize/`: deleted after preserving the useful
  calibration-board watch-list in `docs/calibration_module.md`.
- `docs/old_session/`: historical summaries; keep unless the project adopts an
...
- Decide whether `docs/architecture_docs/` remains hand-maintained API
