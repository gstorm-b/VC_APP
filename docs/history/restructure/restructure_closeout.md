...
- Documented the qmake + MSVC build flow in
  [build_and_verification.md](../../rules/build_and_verification.md).
...
- [build_and_verification.md](../../rules/build_and_verification.md) for qmake/MSVC build
  and test flow.
- [phase4_product_release_plan.md](../../product/phase4_product_release_plan.md) for product
  packaging decisions.
- [technical_debt_and_next_steps.md](../../backlog/technical_debt_and_next_steps.md) for the
