...
work should start from [restructure_closeout.md](restructure_closeout.md) and
[technical_debt_and_next_steps.md](technical_debt_and_next_steps.md).
...
3. `docs/design_rules.md` and `docs/ui_design_rules.md` for process, language,
   UI, QSS, and architecture conventions.
4. `docs/task_localization/` and `docs/robot_kinematics_module.md` for current
   module-level behavior.
5. `uml/*.puml` for structural contracts that should mirror the code.
6. `docs/later_todo_list.md` for deferred work only; resolved or superseded
   items must not remain indistinguishable from open work.
7. `docs/architecture_docs/` for API reference only. If an entry is stale, fix
...
- P0.2 Repair high-confidence documentation drift:
  ...
  - `docs/architecture_docs/ITask.md` must use the current `TaskState` enum and
...
[phase0_documentation_audit.md](phase0_documentation_audit.md).
...
- Decide whether architecture reference docs in `docs/architecture_docs/` are
...
[phase1_baseline_verification.md](phase1_baseline_verification.md).
...
[phase2_phase3_runtime_hardening.md](phase2_phase3_runtime_hardening.md).
...
to [technical_debt_and_next_steps.md](technical_debt_and_next_steps.md).
...
- UI changes pass `docs/ui_design_rules.md` checklist.
...
- Define installer layout for app binaries, Qt/OpenCV/Basler dependencies,
  ...
  in [customer_installer_packaging.md](customer_installer_packaging.md).
...
[phase4_product_release_plan.md](phase4_product_release_plan.md) and
[customer_installer_packaging.md](customer_installer_packaging.md). Actual
...
[technical_debt_and_next_steps.md](technical_debt_and_next_steps.md), keep
